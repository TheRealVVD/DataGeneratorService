...
public class KafkaConfig {
    ...
    public NewTopic powerTopic() {
        return TopicBuilder.name("power-topic")
                .partitions(5)
                .replicas(1)
                .config(
                        TopicConfig.RETENTION_MS_CONFIG,
    ...
    public NewTopic voltageTopic() {
        return TopicBuilder.name("voltage-topic")
                .partitions(5)
                .replicas(1)
                .config(
                        TopicConfig.RETENTION_MS_CONFIG,
    ...
    public SenderOptions<String, Object> senderOptions() {
        ...
        props.put(
                ...
                new TextXPath(this.settings, "//keySerializer") //из producer.xml
                        .toString()
        );
        props.put(
                ProducerConfig.VALUE_SERIALIZER_CLASS_CONFIG,
                new TextXPath(this.settings, "//valueSerializer") //из producer.xml
                        .toString()
        );
